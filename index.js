...
*/
const A187 = '👾AlfinBOT👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/alpinofc12'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6289690719275'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'kosong'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://www.youtube.com/channel/UCPfM-qelpkAnDwBPF00k_XQ'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Alfin ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by alfin`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by alfin`)
})
...
conn.sendMessage(id, ' *Owner alfin wa.me/+6289690719275* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator alpin OFC* ' ,MessageType.text);
}
else if (text == 'Pagi'){
